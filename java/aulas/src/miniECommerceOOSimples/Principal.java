			...
			do { // laço dos comandos do usuário
				...
				if (comando == 'a') {
					...
					try {
						...
						boolean result = trocarProdutos(codProduto, qtdProduto, carrinho, estoque); //adiciona qtdProduto ao carrinho, e retira a mesma quantidade do estoque
						linha(90);
						if (result) {
						...
						System.out.println("A quantidade deve ser inteira");
					}
				}
				// comando para retirar um produto ao carrinho
					...
					try {
						qtdProduto = ler.nextInt();
						boolean result = trocarProdutos(codProduto, qtdProduto, estoque, carrinho); //retira qtdProduto do carrinho, e coloca a mesma quantidade no estoque
						linha(90);
						if (result) {
							...
							System.out.print("\n\n\n***NÃO FOI POSSÍVEL RETIRAR O PRODUTO DO CARRINHO***\n\n\n");
						}
					}
					catch (Exception e) {
						System.out.println("A quantidade deve ser inteira");
